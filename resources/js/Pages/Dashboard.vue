      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center gap-4">
            <button
              class="px-4 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
            >
              Last ned rapport
            </button>
            <button
        ...
        <div class="p-6 bg-white border border-gray-200 rounded-lg">
          <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center space-x-2">
              <button
                class="rounded-md px-3 py-1.5 text-sm font-medium text-gray-600 hover:text-gray-900"
              >
                7D
              </button>
              <button
                class="rounded-md bg-gray-100 px-3 py-1.5 text-sm font-medium text-gray-900"
              >
                30D
              </button>
              <button
              ...
              <div class="flex-1 space-y-3">
                ...
                <div class="flex items-center space-x-2">
                  <span class="text-sm text-gray-500"
                    >{{ campaign.clicks }} klikk</span
                  >
                  <span class="text-gray-300">|</span>
                  <div class="flex items-center space-x-2">
                    <span
                      class="inline-flex items-center px-2 py-1 text-xs font-medium text-blue-600 bg-blue-100 rounded-full"
                    >
                      FB {{ campaign.sources.facebook }}%
                    </span>
                    <span
                      class="inline-flex items-center px-2 py-1 text-xs font-medium text-pink-600 bg-pink-100 rounded-full"
                    >
                      IG {{ campaign.sources.instagram }}%
                    </span>
                    <span
                      class="inline-flex items-center px-2 py-1 text-xs font-medium text-purple-600 bg-purple-100 rounded-full"
                    >
